...
import { Zap, Bell, PlusCircle, Hash, Table as TableIcon, Layout } from 'lucide-react';
    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] gap-8 py-10 font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-7xl px-4">
        ...
        <button 
          ...
          className="group relative bg-slate-800/40 backdrop-blur-sm p-8 rounded-[2.5rem] border border-white/5 hover:border-green-500/50 transition-all hover:-translate-y-2 flex flex-col items-end shadow-2xl overflow-hidden"
        >
        ...
        <button 
          ...
          className="group relative bg-slate-800/40 backdrop-blur-sm p-8 rounded-[2.5rem] border border-white/5 hover:border-yellow-500/50 transition-all hover:-translate-y-2 flex flex-col items-end shadow-2xl overflow-hidden"
        >
        ...
        <button 
          ...
          className="group relative bg-slate-800/40 backdrop-blur-sm p-8 rounded-[2.5rem] border border-white/5 hover:border-blue-500/50 transition-all hover:-translate-y-2 flex flex-col items-end shadow-2xl overflow-hidden"
        >
        ...
        {/* كرت الجداول - الفيتشر الجديدة */}
        <button 
          onClick={() => goTo('/quiz-tables')}
          className="group relative bg-slate-800/40 backdrop-blur-sm p-8 rounded-[2.5rem] border border-white/5 hover:border-purple-500/50 transition-all hover:-translate-y-2 flex flex-col items-end shadow-2xl overflow-hidden"
        >
          <TableIcon className="text-purple-500 mb-6 w-14 h-14 group-hover:scale-110 group-hover:drop-shadow-[0_0_15px_rgba(168,85,247,0.5)] transition-all" />
          <h3 className="text-2xl font-black text-right mb-2 text-white">فقرة الجداول</h3>
          <p className="text-slate-400 text-right text-sm leading-relaxed">تاريخ البطولات، مجموعات كأس العالم، وأي داتا دقيقة.</p>
          <div className="absolute bottom-4 left-6 opacity-0 group-hover:opacity-100 transition-opacity font-black text-purple-500">ابدأ الآن ←</div>
        </button>

      </div>

      {/* Footer Settings/Add Section */}
      <div className="flex flex-wrap justify-center gap-4 mt-12 bg-slate-900/50 p-4 rounded-[2rem] border border-white/5 shadow-inner">
        <button 
          onClick={() => goTo('/add')}
          className="flex items-center gap-2 bg-white/5 hover:bg-white/10 px-6 py-3 rounded-2xl text-slate-300 hover:text-white transition-all border border-white/5"
        >
          <PlusCircle size={20} className="text-green-500" />
          <span className="font-bold text-sm">إدارة (تعويض / جرس)</span>
        </button>
        ...
        >
          ...
          <span className="font-bold text-sm">إدارة الأرقام</span>
        </button>
        ...
        >
          ...
          <span className="font-bold text-sm">إدارة الجداول</span>
        </button>
      </div>
    </div>
  );
