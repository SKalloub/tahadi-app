...
import { Zap, Bell, PlusCircle, Hash, Settings } from 'lucide-react';
    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] gap-8 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl px-4">
        ...
        >
          ...
          <h3 className="text-2xl font-black text-right mb-2">فقرة التعويض</h3>
